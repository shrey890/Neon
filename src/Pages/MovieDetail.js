            ...
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                    ...
                    { movie.genres && movie.genres.length > 0 && (
                        <p className="my-7 flex flex-wrap gap-2">
                            { movie.genres.map((genre) => (
                                <span
                                    className="mr-2 border rounded border-gray-200 dark:border-gray-600 p-2"
                                    key={ genre.id }
                                >
                                    { genre.name }
                                </span>
                    ...
                    <p className="my-4">
                        ...
                        <a className="text-blue-700 underline" href={ `https://www.imdb.com/title/${movie.imdb_id}` } target="_blank" rel='noreferrer'>{ movie.imdb_id }</a>
                    </p>
                </div>
            </section>
        </main>
